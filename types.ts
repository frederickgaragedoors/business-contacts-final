...
export type JobStatus = 'Scheduled' | 'In Progress' | 'Awaiting Parts' | 'Completed' | 'Paid';
...
export const jobStatusColors: Record<JobStatus, { base: string, text: string }> = {
  ...
  Paid: { base: 'bg-slate-200 dark:bg-slate-700', text: 'text-slate-700 dark:text-slate-200' },
};
