            ...
            React.createElement("div", { className: "h-full flex flex-col bg-white dark:bg-slate-800 overflow-y-auto" },
                ...
                React.createElement("div", { className: "flex flex-col items-center px-4 sm:px-6 py-6 bg-slate-50 dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700" },
                    ...
                    React.createElement("div", { className: "flex space-x-3 mt-4" },
                        React.createElement("a", { href: `tel:${contact.phone}`, className: "px-4 py-2 flex items-center space-x-2 text-sm font-medium rounded-full text-sky-700 bg-sky-100 dark:bg-sky-900/50 dark:text-sky-300 hover:bg-sky-200 dark:hover:bg-sky-900 transition-colors" },
                            React.createElement(PhoneIcon, { className: "w-4 h-4" }), React.createElement("span", null, "Call")
                        ),
                         React.createElement("a", { href: `mailto:${contact.email}`, className: "px-4 py-2 flex items-center space-x-2 text-sm font-medium rounded-full text-sky-700 bg-sky-100 dark:bg-sky-900/50 dark:text-sky-300 hover:bg-sky-200 dark:hover:bg-sky-900 transition-colors" },
                            React.createElement(MailIcon, { className: "w-4 h-4" }), React.createElement("span", null, "Email")
                        ),
