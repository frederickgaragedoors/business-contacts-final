            ...
            React.createElement("div", { className: "h-full flex flex-col bg-white dark:bg-slate-800 overflow-y-auto" },
                ...
                React.createElement("div", { className: "flex flex-col items-center px-4 sm:px-6 py-6 bg-slate-50 dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700" },
                    ...
                    React.createElement("div", { className: "flex space-x-3 mt-4" },
                        ...
                        React.createElement("button", { onClick: onDelete, className: "p-2 rounded-full text-red-600 bg-red-100 dark:bg-red-900/50 dark:text-red-400 hover:bg-red-200 dark:hover:bg-red-900 transition-colors" },
                            React.createElement(TrashIcon, { className: "w-5 h-5" })
                        )
                    )
                ),
                React.createElement("div", { className: "grid grid-cols-3 gap-4 p-4 border-b border-slate-200 dark:border-slate-700" },
                    React.createElement("a", { href: `tel:${contact.phone}`, className: "flex flex-col items-center p-3 rounded-lg hover:bg-sky-50 dark:hover:bg-sky-900/50 transition-colors text-sky-600 dark:text-sky-400" },
                        React.createElement(PhoneIcon, { className: "w-6 h-6 mb-1" }),
                        React.createElement("span", { className: "text-sm font-medium" }, "Call")
                    ),
                    React.createElement("a", { href: `sms:${contact.phone}`, className: "flex flex-col items-center p-3 rounded-lg hover:bg-sky-50 dark:hover:bg-sky-900/50 transition-colors text-sky-600 dark:text-sky-400" },
                        React.createElement(MessageIcon, { className: "w-6 h-6 mb-1" }),
                        React.createElement("span", { className: "text-sm font-medium" }, "Text")
                    ),
                    React.createElement("a", { href: `mailto:${contact.email}`, className: "flex flex-col items-center p-3 rounded-lg hover:bg-sky-50 dark:hover:bg-sky-900/50 transition-colors text-sky-600 dark:text-sky-400" },
                ...
                React.createElement("div", { className: "px-4 sm:px-6 py-6 space-y-4" },
                    React.createElement("div", { className: "flex items-start" },
                        ...
                        React.createElement("div", { className: "ml-4" },
                            React.createElement("p", { className: "font-semibold text-slate-700 dark:text-slate-200" }, contact.email),
                ...
                allCustomFields.length > 0 && (
                    React.createElement("div", { className: "px-4 sm:px-6 py-6 border-t border-slate-200 dark:border-slate-700" },
                ...
                React.createElement("div", { className: "px-4 sm:px-6 py-6 border-t border-slate-200 dark:border-slate-700" },
                    React.createElement("div", { className: "flex justify-between items-center mb-4" },
                        React.createElement("div", { className: "flex items-center" },
                            ...
                            React.createElement("h2", { className: "ml-3 text-lg font-semibold text-slate-800 dark:text-slate-100" }, "Jobs")
                        ),
                    ...
                    sortedJobTickets.length > 0 ? (
                        React.createElement("ul", { className: "space-y-4" },
                            sortedJobTickets.map(ticket => {
                                ...
                                return React.createElement("li", { key: ticket.id, className: "p-4 bg-slate-50 dark:bg-slate-700/50 rounded-lg" },
                        ...
                        React.createElement("div", { className: "text-center text-slate-500 dark:text-slate-400 py-4" },
